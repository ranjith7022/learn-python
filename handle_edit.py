...
def handle_edit(document, edit_type, edit):
    match edit_type:
        ...
        case EditType.DELETE:
            value = document.split("\n")
            value[edit["line_number"]] = value[edit["line_number"]][:edit["start"]] + value[edit["line_number"]][edit["end"]:]  #+   
            return "\n".join(value)
        case EditType.SUBSTITUTE:
            value = document.split("\n")
            value[edit["line_number"]] = value[edit["line_number"]][:edit["start"]] + edit["insert_text"]+ value[edit["line_number"]][edit["end"]:]  #+   
            return "\n".join(value)
